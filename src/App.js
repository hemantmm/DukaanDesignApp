  ...
  return (
   <>
    <div className='flex home'>
      <div className='sticky bg-slate-700 h-screen w-56 inset-0 text-stone-300'>
        ...
        <div className='flex justify-between pt-4 pb-4 pr-8 pl-8 bg-white border-b border-solid border-slate-700'>
          ...
          <div className='flex gap-3'>
            <div className='flex items-center justify-center h-10 w-10 cursor-pointer bg-neutral-200 text-neutral-200 rounded-full'>
              {/* image */}
              <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz34AAAACXBIWXMAAAsTAAALEwEAmpwYAAAAaklEQVR4nO2UQQ6AIAwE53nyKvyq8g/rpScVDNJGDt2kB2gyE/YARDqSgALI4BRl3bIZwEVnfxIcuhyN1DghmLMiudy9nZsC+UPwJSGYuKLi/dklXVjAl56nCpBHe2sJsgccbzjA6gk3ywkyJY+nqBq3zQAAAABJRU5ErkJggg==" alt='message' />
            </div>
            <div className='flex items-center justify-center h-10 w-10 cursor-pointer bg-neutral-200 text-neutral-200 rounded-full'>
              {/* image */}
